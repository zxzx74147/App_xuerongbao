...
import com.wazxb.zhuxuebao.databinding.ActivityCaculateBinding;
 ...
 */
public class CaculateActivity extends ZXBBaseActivity {

    private ActivityCaculateBinding mBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_caculate);
        addTabs();
    }
    ...
    private void addTabs() {
        mBinding.tabHost.setup(this, getSupportFragmentManager());
        {
            ...
            CaculateFragment fragment = new CaculateFragment();
